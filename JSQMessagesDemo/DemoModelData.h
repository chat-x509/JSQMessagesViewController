...
static NSString * const kJSQDemoAvatarDisplayNameSquires = @"Євген Гадібіров";
static NSString * const kJSQDemoAvatarDisplayNameCook = @"Максим Сохацький";
static NSString * const kJSQDemoAvatarDisplayNameJobs = @"Євген Жарков";
static NSString * const kJSQDemoAvatarDisplayNameWoz = @"Денис Потапов";
