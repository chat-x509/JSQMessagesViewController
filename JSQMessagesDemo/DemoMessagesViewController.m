...
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForCellTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JSQMessage *message1 = [self.demoData.messages objectAtIndex:indexPath.item];
    JSQMessage *message2 = message1;
    if (indexPath.item < self.demoData.messages.count - 1) {
        long index = indexPath.item + 1;
        message2 = [self.demoData.messages objectAtIndex:index];
    }
    
    NSCalendar *gregorianCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    NSDateComponents *components = [gregorianCalendar components:NSCalendarUnitDay
                                                        fromDate:message1.date
                                                          toDate:message2.date
                                                         options:0];
                   ...
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout heightForCellTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDateComponents *components = [gregorianCalendar components:NSCalendarUnitDay
                                                        fromDate:message1.date
                                                          toDate:message2.date
                                                         options:0];
    NSLog(@"Day: %ld, %ld, %ld", components.day, indexPath.item, self.demoData.messages.count);
