...
- (instancetype)init
{
    ...
    if (self) {
        ...
        JSQMessagesAvatarImage *jsqImage = [avatarFactory avatarImageWithUserInitials:@"МС"
...
- (void)loadFakeMessages
{
    ...
    NSDate *yesterday = [today dateByAddingTimeInterval: -186400.0];
    
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdSquires
                                        senderDisplayName:kJSQDemoAvatarDisplayNameSquires
                                                     date:yesterday
                                                     text:NSLocalizedString(@"Так, ну шо, шо тут за хуйня?", nil)],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdWoz
                                        senderDisplayName:kJSQDemoAvatarDisplayNameWoz
                                                     date:yesterday
                                                     text:NSLocalizedString(@"Та Сохацький прєсує, хоче спрінг баблзи.", nil)],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdSquires
                                        senderDisplayName:kJSQDemoAvatarDisplayNameSquires
                                                     date:yesterday
                                                     text:NSLocalizedString(@"Ну так напиши, ти ж програміст.", nil)],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdJobs
                                        senderDisplayName:kJSQDemoAvatarDisplayNameJobs
                                                     date:today
                                                     text:NSLocalizedString(@"Спакуха пацани, я всьо написав.", nil)],

                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdJobs
                                        senderDisplayName:kJSQDemoAvatarDisplayNameJobs
                                                     date:today
                                                     text:NSLocalizedString(@"4 години, з вас 500 баксів.", nil)],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdCook
                                        senderDisplayName:kJSQDemoAvatarDisplayNameCook
                                                     date:today
                                                     text:NSLocalizedString(@"Краще ніж в Апола.", nil)],

                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdSquires
                                        senderDisplayName:kJSQDemoAvatarDisplayNameSquires
                                                     date:today
                                                     text:NSLocalizedString(@"Ну це вже не шось подібно.", nil)],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQDemoAvatarIdSquires
                                        senderDisplayName:kJSQDemoAvatarDisplayNameSquires
                                                     date:today
                                                     text:NSLocalizedString(@"Заєбок!", nil)],
                     nil];
